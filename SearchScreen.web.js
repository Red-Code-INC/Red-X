...
const SearchScreen = () => {
  ...
  return (
    ...
    <View style={[styles.searchContainer,{backgroundColor: Red()}]}>
      <Ionicons size={21} style={[styles.searchIcon,{backgroundColor:Red(),borderColor: Red()}]} name={"search"}/>
      <TextInput
      ...
      {searchQuery.length > 0 && (
          <TouchableOpacity 
            ...
            >
            <Ionicons name="close" size={30} color={hoveredIndex === "Clear" ? Red2() : Red()} />
          </TouchableOpacity>
        )}
      </View>
