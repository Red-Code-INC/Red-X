...
const QuizScreen = ({ navigation }) => {
  ...
  return (
    <View style={[styles.container, Styles().container]}>
      <Text style={[styles.question, Styles().text,{fontFamily: Font()}]}>{questions[currentQuestion]?.question || "Loading..."}</Text>
...
const styles = StyleSheet.create({
  ...
  button: { padding: 10, borderRadius: 10, marginVertical: 5, width: '80%' },
